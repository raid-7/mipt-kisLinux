...
asmlinkage long extspecified_ptr(void *ptr);
asmlinkage long extspecified_ptr_uint(void *ptr, unsigned int val)
asmlinkage long extspecified_ptr_uint_ptr(void *ptr0, unsigned int val, void *ptr1);
